    ...
    <main className="guide-page">
      ...
      <section className="guide-hero">
        ...
        <dl className="guide-date-card">
          <div><dt>START</dt><dd>9.7 MON<br /><strong>12:30</strong></dd></div>
          <div><dt>FINISH</dt><dd>9.11 FRI<br /><strong>13:30</strong></dd></div>
          <div><dt>STAY</dt><dd><strong>2인 1실</strong><br />비전캠퍼스</dd></div>
        </dl>
      </section>
      ...
      <section className="guide-section" id="before">
        <div className="guide-section-title">
          <span>01</span><p className="eyebrow">GET READY</p><h2>참여 전 준비</h2>
        </div>
        <div className="guide-card-grid">
          ...
          <article className="guide-card">
            ...
            <h3>꼭 챙겨 주세요</h3>
            <ul><li>개인 위생용품</li><li>개인 수건</li><li>저녁시간 활동복</li><li>개인 상비약</li></ul>
          </article>
          <article className="guide-card">
      ...
      <section className="guide-section guide-travel" id="travel">
        <div className="guide-section-title inverse">
          <span>02</span><p className="eyebrow light">HOW TO ARRIVE</p><h2>이동 안내</h2>
        </div>
        <div className="travel-board">
          <article>
            <div className="travel-label"><span>9.7</span><strong>교육 시작</strong></div>
            <div className="travel-content">
              <h3>월요일 오후 12시 30분</h3>
              <p>대중교통 이용자는 열차를 개인 예약한 뒤 이동합니다.</p>
              <div className="train-grid">
                <div><small>KTX 318</small><strong>10:01 → 11:46</strong><span>수서역 도착</span></div>
                <div><small>KTX 018</small><strong>09:32 → 11:24</strong><span>서울역 도착</span></div>
                <div><small>KTX 020</small><strong>09:38 → 11:28</strong><span>서울역 도착</span></div>
              </div>
            </div>
          </article>
          <article>
            <div className="travel-label"><span>9.11</span><strong>교육 종료</strong></div>
            <div className="travel-content">
              <h3>금요일 오후 1시 30분</h3>
              <div className="departure-grid">
                <div><small>서울권 교육생</small><p>셔틀버스로 동대구역 이동<br /><b>예상 도착 오후 3시</b></p></div>
                <div><small>대구권 교육생</small><p>동일 셔틀버스로 용산역<br /><b>대구 지하철 2호선 하차</b></p></div>
                <div><small>개별 이동</small><p>별도 개인 이동도<br /><b>가능합니다.</b></p></div>
              </div>
            </div>
          </article>
        </div>
      ...
      <section className="guide-section" id="stay">
        <div className="guide-section-title">
          <span>03</span><p className="eyebrow">VISION CAMPUS</p><h2>숙박 안내</h2>
        </div>
        <div className="stay-layout">
          <div className="stay-lead">
            <strong>2</strong><span>PERSON / ROOM</span>
            <h3>2인 1실로<br />배정됩니다.</h3>
            <p>비전캠퍼스 내에는 세면도구를 구매할 수 있는 시설이 없습니다.</p>
          </div>
          <div className="stay-checklist">
            <article><span>구비 품목</span><h3>샴푸 · 치약</h3><p>객실에는 샴푸와 치약만 준비되어 있습니다.</p></article>
            <article className="accent"><span>필수 지참</span><h3>세면도구 · 수건</h3><p>개인 세면도구와 수건을 반드시 챙겨 주세요.</p></article>
            <article><span>상비약</span><h3>두통 · 감기 · 소화제</h3><p>기본 상비약은 구비되어 있으며, 개인에게 필요한 약은 별도로 준비합니다.</p></article>
          </div>
        </div>
      </section>
      ...
      <section className="guide-section rules-section" id="rules">
        <div className="guide-section-title inverse">
          <span>04</span><p className="eyebrow light">MUST READ</p><h2>숙소 준수사항</h2>
        </div>
        <p className="rules-intro">모두가 안전하고 편안하게 머물 수 있도록 아래 내용을 반드시 확인해 주세요.</p>
        <ol className="rule-list">{stayRules.map((rule) => <li key={rule}>{rule}</li>)}</ol>
        <div className="prohibited-box">
          <div><p className="eyebrow light">NOT ALLOWED</p><h3>숙소 내 금지사항</h3><p>위반 시 즉시 퇴실 조치될 수 있습니다.</p></div>
      ...
      <section className="guide-contact">
        ...
        <a href="mailto:mwkim@daedong.co.kr">mwkim@daedong.co.kr <span>↗</span></a>
        <p>인사혁신팀(교육)</p>
      </section>

      <footer className="guide-footer"><img src="/images/daedong-logo.png" alt="DAEDONG" /><p>2026 하반기 Great Journey · 교육 준비 안내</p><Link href="/">홈으로 돌아가기</Link></footer>
    </main>
  );
}
