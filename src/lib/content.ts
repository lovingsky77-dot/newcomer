...
export const schedules: Record<string, { date: string; place: string; theme: string; items: ScheduleItem[] }> = {
  "DAY 1": {
    ...
    theme: "연결의 시작",
    items: [
      { time: "12:30", title: "Ice Breaking & 과정소개", type: "welcome", detail: "1시간" },
      { time: "13:30", title: "환영사", type: "welcome", detail: "1시간" },
      { time: "14:30", title: "사업부문 소개", type: "business", detail: "1시간" },
      { time: "15:30", title: "대동 농기계 상품 소개", type: "business", detail: "1시간" },
      { time: "16:30", title: "자율주행 & 정밀농업 소개", type: "business", detail: "1시간" },
      { time: "17:30", title: "1일차 마무리", type: "welcome" },
    ],
  },
  "DAY 2": {
    date: "9/8",
    ...
    theme: "사업을 읽는 시선",
    items: [
      { time: "09:00", title: "모빌리티 & 로보틱스 사업소개", type: "business", detail: "1.5시간" },
      { time: "10:30", title: "Agtech & AILab 사업소개", type: "business", detail: "1.5시간" },
      { time: "12:00", title: "점심 및 이동", type: "move", detail: "서울사무소 → 동부권역센터" },
      { time: "16:00", title: "동부권역센터 투어", type: "experience", detail: "1시간" },
      { time: "17:00", title: "비전캠퍼스로 이동", type: "move", detail: "동부권역센터 → 창녕비전캠퍼스" },
      { time: "17:30", title: "2일차 마무리", type: "welcome" },
    ],
  },
  "DAY 3": {
    date: "9/9",
    place: "창녕비전캠퍼스 · 성서통합R&D센터",
    theme: "나의 미래를 설계하다",
    items: [
      { time: "09:00", title: "팀빌딩 & 자기비저닝", type: "vision", detail: "3시간" },
      { time: "12:00", title: "점심", type: "welcome" },
      { time: "13:00", title: "성서통합R&D센터로 이동", type: "move", detail: "창녕비전캠퍼스 → 성서통합R&D센터" },
      { time: "14:00", title: "개발부문 소개", type: "business", detail: "1시간" },
      { time: "15:00", title: "개발 프로세스 소개", type: "business", detail: "1.5시간" },
      { time: "16:30", title: "비전캠퍼스로 이동", type: "move", detail: "성서통합R&D센터 → 창녕비전캠퍼스" },
      { time: "17:30", title: "3일차 마무리", type: "welcome" },
    ],
  },
  "DAY 4": {
    date: "9/10",
    place: "모빌리티 신공장 · 대동금속 · 대구공장 · 그룹시험센터",
    theme: "현장에서 발견하다",
    items: [
      { time: "09:00", title: "모빌리티 신공장 투어", type: "experience", detail: "1.5시간" },
      { time: "10:30", title: "대동금속으로 이동", type: "move", detail: "모빌리티 신공장 → 대동금속" },
      { time: "11:00", title: "대동금속 투어", type: "experience", detail: "1시간" },
      { time: "12:00", title: "점심 및 이동", type: "move", detail: "대동금속 → 대구공장" },
      { time: "13:30", title: "공장부문 소개", type: "business", detail: "1시간" },
      { time: "14:30", title: "공장현장 투어", type: "experience", detail: "1시간" },
      { time: "15:30", title: "그룹시험센터로 이동", type: "move", detail: "대구공장 → 창녕비전캠퍼스" },
      { time: "16:30", title: "그룹시험센터 투어", type: "experience", detail: "1시간" },
      { time: "17:30", title: "4일차 마무리", type: "welcome" },
    ],
  },
  "DAY 5": {
    date: "9/11",
